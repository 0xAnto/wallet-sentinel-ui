...
export function GradientButton({ className, variant = "blue-purple", ...props }: GradientButtonProps) {
  const variants = {
    ...
    "green-emerald": "bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700",
    "purple-pink": "bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700",
    "red-orange": "bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700",
  }
