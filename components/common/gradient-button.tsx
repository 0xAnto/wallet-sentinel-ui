...
interface GradientButtonProps extends ButtonProps {
  gradient?: "blue-purple" | "green-emerald" | "purple-pink" | "red-orange"
}

export function GradientButton({ className, gradient = "blue-purple", ...props }: GradientButtonProps) {
  const gradients = {
    "blue-purple": "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white",
    "green-emerald": "bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white",
  ...
  return <Button className={cn(gradients[gradient], className)} {...props} />
}
